...
export default ModalDestructuring
        `})}),J=()=>(s.exports.useEffect(()=>{q.highlightAll()},[]),o(s.exports.Fragment,{children:[e(I,{title:"Modal",data:[{title:"Components"},{title:"Modal"}]}),e(f,{children:e(k,{sm:"12",children:o(M,{title:"Modal Basic",code:T,children:[o(C,{className:"mb-0",children:["Use ",e("code",{children:"Modal"}),", ",e("code",{children:"ModalBody"})," and ",e("code",{children:"ModalFooter"})," tags to create a Modal with reactstrap."]}),e(x,{})]})})}),o(f,{children:[e(k,{sm:"12",children:o(M,{title:"Modal Themes",code:A,children:[o(C,{className:"mb-0",children:["Use class ",e("code",{children:".modal-[color]"})," with your ",e("code",{children:".modal"})," to change theme of modal"]}),e(S,{})]})}),e(k,{sm:"12",children:o(M,{title:"Modal Sizes",code:P,children:[o(C,{className:"mb-0",children:["Use class ",e("code",{children:".modal-[xs/sm/lg/xl]"})," with ",e("code",{children:"ModalHeader"})," to change modal Size."]}),e(F,{})]})}),e(k,{sm:"12",children:o(M,{title:"Modal Events",code:H,children:[o(C,{className:"mb-0",children:["Use props ",e("code",{children:"onClosed / onOpened"})," for modal events."]}),e(N,{})]})})]}),o(f,{children:[e(k,{sm:"12",children:e(M,{title:"Form & Scrolling Modals",code:z,children:e(D,{})})}),e(k,{sm:"12",children:o(M,{title:"Unmount On Close",code:V,children:[e(C,{children:"Write something (data should remain in modal if unmountOnClose is set to false)."}),e(E,{})]})})]})]}));export{J as default};
