...
`})}),O=()=>(n.exports.useEffect(()=>{m.highlightAll()},[]),t(n.exports.Fragment,{children:[o(h,{title:"Tooltips",data:[{title:"Components"},{title:"Tooltips"}]}),t(a,{children:[o(i,{xl:"6",lg:"12",children:t(p,{title:"Controlled Tooltip",code:f,children:[t(r,{children:["For controlled tooltips you'll have to manage state of component.controlled tooltips require"," ",o("code",{children:"isOpen"})," and ",o("code",{children:"toggle"})," props to work."]}),o(g,{})]})}),o(i,{xl:"6",lg:"12",children:t(p,{title:"Uncontrolled Tooltip",code:B,children:[t(r,{children:["UncontrolledTooltip does not require ",o("code",{children:"isOpen"})," nor ",o("code",{children:"toggle"})," props to work.All you have to do is provide a valid target to tooltip."]}),o(u,{})]})})]}),o(a,{children:o(i,{sm:"12",children:t(p,{title:"Tooltip Positions",code:U,children:[t(r,{className:"mb-0",children:["Use prop ",o("code",{children:"placement"})," to change position of tooltip."]}),o(T,{})]})})})]}));export{O as default};
