import{o as t,j as a,cr as c,bU as l,cs as m,G as g,r as n,cj as v,ae as h,af as o,ah as e}from"./index.b8b13c58.js";import{C as i}from"./index.9b59a91a.js";import{B as u}from"./index.4c823db6.js";import{A as r,af as A,G as d,bj as f,bk as I,ag as x,q as y}from"./App.e1b9a34b.js";import{a as s}from"./avatar-s-20.3ee3e4a2.js";import{A as p}from"./index.b09f352c.js";const P=()=>t("div",{className:"demo-inline-spacing",children:[a(r,{img:s,size:"sm"}),a(r,{img:s}),a(r,{img:s,size:"lg"}),a(r,{img:s,size:"xl"})]}),z=()=>t("div",{className:"demo-inline-spacing",children:[a(r,{color:"primary",icon:a(A,{size:14})}),a(r,{color:"secondary",icon:a(d,{size:14})}),a(r,{color:"success",icon:a(f,{size:14})}),a(r,{color:"light-danger",icon:a(I,{size:14})}),a(r,{color:"light-warning",icon:a(x,{size:14})}),a(r,{color:"light-info",icon:a(y,{size:14})})]}),N=[{img:c},{img:l},{img:m},{img:g},{img:s}],C=()=>a(p,{data:N}),b=()=>t("div",{className:"demo-inline-spacing",children:[a(r,{color:"primary",content:"PI"}),a(r,{color:"secondary",content:"PI"}),a(r,{color:"success",content:"PI"}),a(r,{color:"danger",content:"PI"}),a(r,{color:"warning",content:"PI"}),a(r,{color:"info",content:"PI"})]}),j=()=>t("div",{className:"demo-inline-spacing",children:[a(r,{img:s,status:"offline"}),a(r,{color:"info",content:"LD",status:"busy"}),a(r,{color:"light-primary",icon:a(d,{size:14}),status:"away"}),a(r,{color:"light-success",content:"AB",status:"online"})]}),G=()=>t("div",{className:"demo-inline-spacing",children:[a(r,{color:"light-primary",content:"Peter Ingraham",size:"sm",initials:!0}),a(r,{color:"light-secondary",content:"Peter Ingraham",initials:!0}),a(r,{color:"light-success",content:"Peter Ingraham",size:"lg",initials:!0}),a(r,{color:"light-danger",content:"Peter Ingraham",size:"xl",initials:!0})]}),w=()=>t("div",{className:"demo-inline-spacing",children:[a(r,{color:"light-primary",content:"PI"}),a(r,{color:"light-secondary",content:"PI"}),a(r,{color:"light-success",content:"PI"}),a(r,{color:"light-danger",content:"PI"}),a(r,{color:"light-warning",content:"PI"}),a(r,{color:"light-info",content:"PI"})]}),S=[{title:"Vinnie Mostowy",img:c},{title:"Elicia Rieske",img:l},{title:"Julee Rossignol",img:m},{title:"Darcey Nooner",img:g},{title:"Jenny Looper",img:s}],q=()=>a(p,{data:S}),L=a("pre",{children:a("code",{className:"language-jsx",children:`
...
export default AvatarGroupComponent
`})}),Y=()=>(n.exports.useEffect(()=>{v.highlightAll()},[]),t(n.exports.Fragment,{children:[a(u,{title:"Avatar",data:[{title:"Components"},{title:"Avatar"}]}),t(h,{className:"match-height",children:[a(o,{xl:"6",lg:"12",children:t(i,{title:"Sizes",code:L,children:[t(e,{className:"mb-0",children:["Use ",a("code",{children:"size=[sm | lg | xl]"})," prop to change avatar's size. You can also use ",a("code",{children:"height"})," &"," ",a("code",{children:"width"})," prop for a custom size"]}),a(P,{})]})}),a(o,{xl:"6",lg:"12",children:t(i,{title:"Intials",code:U,children:[t(e,{className:"mb-0",children:["Use prop ",a("code",{children:"initials"})," to show only Initials of content."]}),a(G,{})]})}),a(o,{xl:"6",lg:"12",children:t(i,{title:"Colors",code:k,children:[t(e,{className:"mb-0",children:["Use prop ",a("code",{children:"color=[primary | success | danger | info | warning | dark]"})," to change background color of your avatar."]}),a(b,{})]})}),a(o,{xl:"6",lg:"12",children:t(i,{title:"Light Colors",code:D,children:[t(e,{className:"mb-0",children:["Use prop"," ",a("code",{children:"color=[light-primary | light-success | light-danger | light-info | light-warning | light-dark]"})," ","to change background color of your avatar."]}),a(w,{})]})}),a(o,{xl:"6",lg:"12",children:t(i,{title:"Icons",code:H,children:[t(e,{className:"mb-0",children:["Use prop ",a("code",{children:"icon"})," to create avatar with icon."]}),a(z,{})]})}),a(o,{xl:"6",sm:"12",children:t(i,{title:"Status",code:R,children:[t(e,{className:"mb-0",children:["Use prop ",a("code",{children:"status=[online | offline | away | busy]"})," to create avatar with status."]}),a(j,{})]})}),a(o,{xl:"6",sm:"12",children:t(i,{title:"Avatar Group",code:B,children:[t(e,{children:["Use ",a("code",{children:"<AvatarGroup />"})," component and pass ",a("code",{children:"data"})," prop to create a grouped avatar."]}),a(e,{children:"Data prop must be an array of object which contains props to be passed on avatar."}),a(C,{})]})}),a(o,{xl:"6",sm:"12",children:t(i,{title:"Avatar Group Tooltip",code:J,children:[t(e,{children:["Add an extra property of ",a("code",{children:"title"})," in the data you pass in ",a("code",{children:"<AvatarGroup />"})," to create avatar group with tooltip."]}),a(q,{})]})})]})]}));export{Y as default};
